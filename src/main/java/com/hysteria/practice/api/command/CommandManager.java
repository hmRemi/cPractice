...
public class CommandManager implements CommandExecutor {
    ...
    public boolean handleCommand(CommandSender sender, org.bukkit.command.Command cmd, String label, String[] args) {
        for (int i = args.length; i >= 0; i--) {
            ...
            if (commandMap.containsKey(cmdLabel)) {
                ...
                com.hysteria.practice.api.command.Command command = method.getAnnotation(com.hysteria.practice.api.command.Command.class);
    ...
    public void registerCommands(Object obj, List<String> aliases) {
        for (Method m : obj.getClass().getMethods()) {
            if (m.getAnnotation(com.hysteria.practice.api.command.Command.class) != null) {
                com.hysteria.practice.api.command.Command command = m.getAnnotation(com.hysteria.practice.api.command.Command.class);
